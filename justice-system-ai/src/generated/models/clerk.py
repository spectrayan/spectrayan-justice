...
class Clerk(BaseModel):
    ...
    position: StrictStr = Field(description="Position or title of the clerk")
    department: Optional[StrictStr] = Field(default=None, description="Department the clerk works in")
    email: Optional[StrictStr] = Field(default=None, description="Clerk's email address")
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    court_id: StrictStr = Field(description="ID of the court the clerk is associated with", alias="courtId")
    years_of_service: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of years the clerk has been in service", alias="yearsOfService")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "position", "department", "email", "phoneNumber", "courtId", "yearsOfService"]
