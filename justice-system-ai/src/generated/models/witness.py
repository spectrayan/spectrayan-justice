...
from generated.models.credibility_level import CredibilityLevel
...
from generated.models.witness_type import WitnessType
...
class Witness(BaseModel):
    ...
    type: WitnessType
    testimony: Optional[StrictStr] = Field(default=None, description="Summary of witness testimony")
    credibility: Optional[CredibilityLevel] = CredibilityLevel.UNKNOWN
    address: Optional[Address] = None
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    email: Optional[StrictStr] = Field(default=None, description="Witness's email address")
    relationship: Optional[StrictStr] = Field(default=None, description="Relationship to the case or parties involved")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "type", "testimony", "credibility", "address", "phoneNumber", "email", "relationship"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credibility": obj.get("credibility") if obj.get("credibility") is not None else CredibilityLevel.UNKNOWN,
