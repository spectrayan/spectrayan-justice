...
from generated.models.custody_status import CustodyStatus
...
class Defendant(BaseModel):
    ...
    date_of_birth: date = Field(description="Defendant's date of birth", alias="dateOfBirth")
    address: Optional[Address] = None
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    email: Optional[StrictStr] = Field(default=None, description="Defendant's email address")
    criminal_history: Optional[StrictStr] = Field(default=None, description="Summary of defendant's criminal history", alias="criminalHistory")
    custody_status: Optional[CustodyStatus] = Field(default=None, alias="custodyStatus")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "dateOfBirth", "address", "phoneNumber", "email", "criminalHistory", "custodyStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "criminalHistory": obj.get("criminalHistory"),
            "custodyStatus": obj.get("custodyStatus")
        })
        return _obj
