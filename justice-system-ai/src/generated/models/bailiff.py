...
class Bailiff(BaseModel):
    ...
    badge_number: StrictStr = Field(description="Bailiff's badge or identification number", alias="badgeNumber")
    rank: Optional[StrictStr] = Field(default=None, description="Bailiff's rank or position")
    email: Optional[StrictStr] = Field(default=None, description="Bailiff's email address")
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    court_id: StrictStr = Field(description="ID of the court the bailiff is assigned to", alias="courtId")
    years_of_service: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of years the bailiff has been in service", alias="yearsOfService")
    certifications: Optional[List[StrictStr]] = Field(default=None, description="List of certifications held by the bailiff")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "badgeNumber", "rank", "email", "phoneNumber", "courtId", "yearsOfService", "certifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "yearsOfService": obj.get("yearsOfService"),
