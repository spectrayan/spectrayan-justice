...
class EvidenceAllOfPhysicalProperties(BaseModel):
    """
    Physical properties of the evidence (for PHYSICAL type)
    """ # noqa: E501
    dimensions: Optional[StrictStr] = Field(default=None, description="Dimensions of the physical evidence")
    weight: Optional[StrictStr] = Field(default=None, description="Weight of the physical evidence")
    condition: Optional[StrictStr] = Field(default=None, description="Condition of the physical evidence")
    __properties: ClassVar[List[str]] = ["dimensions", "weight", "condition"]
