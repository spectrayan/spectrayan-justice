...
class Reporter(BaseModel):
    ...
    certification_number: StrictStr = Field(description="Court reporter's certification number", alias="certificationNumber")
    email: Optional[StrictStr] = Field(default=None, description="Reporter's email address")
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    court_id: Optional[StrictStr] = Field(default=None, description="ID of the court the reporter is associated with", alias="courtId")
    years_of_experience: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of years of experience as a court reporter", alias="yearsOfExperience")
    specializations: Optional[List[StrictStr]] = Field(default=None, description="Areas of specialization or expertise")
    transcription_rate: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Rate charged per page for transcription services", alias="transcriptionRate")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "certificationNumber", "email", "phoneNumber", "courtId", "yearsOfExperience", "specializations", "transcriptionRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "about": obj.get("about"),
            "certificationNumber": obj.get("certificationNumber"),
            "email": obj.get("email"),
            ...
            "specializations": obj.get("specializations"),
            "transcriptionRate": obj.get("transcriptionRate")
        })
        return _obj
