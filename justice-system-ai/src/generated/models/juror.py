...
class Juror(BaseModel):
    ...
    date_of_birth: date = Field(description="Juror's date of birth", alias="dateOfBirth")
    address: Optional[Address] = None
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    email: Optional[StrictStr] = Field(default=None, description="Juror's email address")
    occupation: Optional[StrictStr] = Field(default=None, description="Juror's occupation")
    jury_duty_history: Optional[StrictStr] = Field(default=None, description="History of previous jury duty service", alias="juryDutyHistory")
    is_foreman: Optional[StrictBool] = Field(default=False, description="Indicates if the juror is the jury foreman", alias="isForeman")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "dateOfBirth", "address", "phoneNumber", "email", "occupation", "juryDutyHistory", "isForeman"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "juryDutyHistory": obj.get("juryDutyHistory"),
            "isForeman": obj.get("isForeman") if obj.get("isForeman") is not None else False
        })
        return _obj
