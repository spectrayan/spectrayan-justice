...
from generated.models.lawyer_type import LawyerType
...
class Lawyer(BaseModel):
    ...
    type: LawyerType
    bar_number: StrictStr = Field(description="Lawyer's bar association number", alias="barNumber")
    firm: Optional[StrictStr] = Field(default=None, description="Law firm or organization the lawyer is associated with")
    email: Optional[StrictStr] = Field(default=None, description="Lawyer's email address")
    phone_number: Optional[Phone] = Field(default=None, alias="phoneNumber")
    address: Optional[Address] = None
    years_of_experience: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Years of experience as a lawyer", alias="yearsOfExperience")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "identity", "personality", "emotionalIntelligence", "physicalTraits", "socialBehavior", "disability", "about", "type", "barNumber", "firm", "email", "phoneNumber", "address", "yearsOfExperience"]
