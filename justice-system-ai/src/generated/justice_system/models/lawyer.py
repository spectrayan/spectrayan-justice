...
from justice_system.models.lawyer_type import LawyerType
...
class Lawyer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "type", "barNumber", "firm", "email", "phoneNumber", "address", "yearsOfExperience"]
