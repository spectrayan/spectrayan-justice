...
from justice_system.models.plaintiff_type import PlaintiffType
...
class Plaintiff(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "type", "address", "phoneNumber", "email", "claimDescription", "damagesRequested", "lawyerId"]
