...
from justice_system.models.case_status import CaseStatus
from justice_system.models.case_type import CaseType
...
class Case(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "caseNumber", "title", "description", "type", "status", "filingDate", "courtId", "judgeId", "prosecutorIds", "defenseAttorneyIds", "defendantIds", "plaintiffIds", "victimIds", "witnessIds", "juryId", "clerkId", "bailiffId", "reporterId", "hearingDates", "verdict", "sentenceDetails"]
