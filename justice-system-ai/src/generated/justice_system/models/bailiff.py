...
class Bailiff(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "badgeNumber", "rank", "email", "phoneNumber", "courtId", "yearsOfService", "certifications"]
