...
class Clerk(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "position", "department", "email", "phoneNumber", "courtId", "yearsOfService"]
