...
from justice_system.models.custody_status import CustodyStatus
...
class Defendant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "dateOfBirth", "address", "phoneNumber", "email", "criminalHistory", "custodyStatus"]
