...
class Reporter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdAt", "updatedBy", "updatedAt", "title", "firstName", "middleName", "lastName", "gender", "certificationNumber", "email", "phoneNumber", "courtId", "yearsOfExperience", "specializations", "transcriptionRate"]
